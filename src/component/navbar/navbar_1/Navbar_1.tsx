                    ...
                    <div className="flex w-full justify-between gap-4 ">
                        <div className="flex flex-1 items-start">
                            ...
                            <a
                                ...
                                className="md:text-body2 text-caption2 inline-block font-semibold text-white"
                            >
                                Khuyến mãi tháng 04
                        ...
                        <div className="hidden items-center gap-5 md:flex text-basic">
                            ...
                            <div className="cursor-pointer inline-flex items-center">
                                ...
                                <div className="ml-1 font-medium text-white">
                                    Tư vấn ngay: <a href="tel:19003085">1900 3085</a>
                                </div>
                            </div>

                            <div className="flex cursor-pointer items-center text-white font-semibold">
